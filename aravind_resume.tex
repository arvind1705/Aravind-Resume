...
\section{Projects} 
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{CSA Generali  - UI }
      {Worked on multiple UI components using ReactJS for CSA Genrali UI page. }
    ...
    \resumeSubItem{Discord Results Chatbot}
      {Chatbot developed using python for retrieval exam results from University website and displaying it in chat window of Discord Application.}
  \resumeSubHeadingListEnd
...
\resumeSubHeadingListStart
  ...
  \item {
    \textbf{Technologies}{: AWS, Heroku, ReactJS, GIT, Django, Flask, Web Sockets}
  }
\resumeSubHeadingListEnd
